    ...
    >
      ...
      <div className="flex">
        ...
        <div className="flex-1 px-3.5 py-3 min-w-0 flex flex-col gap-2">
          <textarea
            className="select-text font-mono text-xs leading-relaxed text-ink w-full bg-transparent outline-none rounded px-1.5 py-1 -mx-1.5 hover:bg-surface focus:bg-surface focus-visible:ring-1 focus-visible:ring-accent/40 transition-colors resize-none break-all max-h-25 overflow-y-auto disabled:pointer-events-none"
